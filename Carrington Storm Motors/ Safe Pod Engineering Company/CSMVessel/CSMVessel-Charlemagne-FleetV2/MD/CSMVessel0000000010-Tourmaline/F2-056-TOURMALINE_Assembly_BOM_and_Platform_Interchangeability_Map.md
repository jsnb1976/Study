# F2-056 — TOURMALINE: Assembly BOM and Platform Interchangeability Map
...
**Section:** Design
**Document:** Assembly BOM and Platform Interchangeability Map
...
## Platform Scaling Applied to Design: Assembly BOM and Platform Interchangeability Map
...
## Fabrication Notes for Assembly BOM and Platform Interchangeability Map

This section covers Design fabrication specifics for TOURMALINE.
...
### Material Requirements (Specific to Assembly BOM and Platform Interchangeability Map)
...
### Quality Check Points for Assembly BOM and Platform Interchangeability Map
...
*Document 56 of 52–135 for TOURMALINE.*
*Second-pass will add specific equations, drawings, and fabrication diagrams.*


---
*End F2-056 | TOURMALINE | CSMVessel-Charlemagne-FleetV2 | June 2026*
