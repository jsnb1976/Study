# F2-095 — TOURMALINE: BMS Architecture and GaN Electronics
...
**Section:** Battery
**Document:** BMS Architecture and GaN Electronics
...
## Platform Scaling Applied to Battery: BMS Architecture and GaN Electronics
...
## Fabrication Notes for BMS Architecture and GaN Electronics
...
### Material Requirements (Specific to BMS Architecture and GaN Electronics)
...
### Quality Check Points for BMS Architecture and GaN Electronics
...
*Document 95 of 52–135 for TOURMALINE.*
*Second-pass will add specific equations, drawings, and fabrication diagrams.*


---
*End F2-095 | TOURMALINE | CSMVessel-Charlemagne-FleetV2 | June 2026*
