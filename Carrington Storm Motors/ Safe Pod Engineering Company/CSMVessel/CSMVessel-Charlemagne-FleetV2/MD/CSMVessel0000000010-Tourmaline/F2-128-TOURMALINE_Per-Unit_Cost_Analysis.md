# F2-128 — TOURMALINE: Per-Unit Cost Analysis
...
**Document:** Per-Unit Cost Analysis
...
## Platform Scaling Applied to Manufacturing: Per-Unit Cost Analysis
...
## Fabrication Notes for Per-Unit Cost Analysis
...
### Material Requirements (Specific to Per-Unit Cost Analysis)
...
### Quality Check Points for Per-Unit Cost Analysis
...
*Document 128 of 52–135 for TOURMALINE.*
*Second-pass will add specific equations, drawings, and fabrication diagrams.*


---
*End F2-128 | TOURMALINE | CSMVessel-Charlemagne-FleetV2 | June 2026*
