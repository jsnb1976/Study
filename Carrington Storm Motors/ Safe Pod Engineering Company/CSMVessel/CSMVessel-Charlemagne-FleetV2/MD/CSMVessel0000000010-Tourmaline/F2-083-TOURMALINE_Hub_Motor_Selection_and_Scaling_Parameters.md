# F2-083 — TOURMALINE: Hub Motor Selection and Scaling Parameters
...
**Section:** Drivetrain
**Document:** Hub Motor Selection and Scaling Parameters
...
## Platform Scaling Applied to Drivetrain: Hub Motor Selection and Scaling Parameters
...
## Fabrication Notes for Hub Motor Selection and Scaling Parameters
...
### Material Requirements (Specific to Hub Motor Selection and Scaling Parameters)
...
### Quality Check Points for Hub Motor Selection and Scaling Parameters
...
*Document 83 of 52–135 for TOURMALINE.*
*Second-pass will add specific equations, drawings, and fabrication diagrams.*


---
*End F2-083 | TOURMALINE | CSMVessel-Charlemagne-FleetV2 | June 2026*
