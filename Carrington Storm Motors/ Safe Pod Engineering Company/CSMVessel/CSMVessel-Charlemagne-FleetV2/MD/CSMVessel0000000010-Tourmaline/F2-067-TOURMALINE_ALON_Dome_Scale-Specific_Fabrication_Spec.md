# F2-067 — TOURMALINE: ALON Dome Scale-Specific Fabrication Spec
...
**Section:** ALON Dome
**Document:** ALON Dome Scale-Specific Fabrication Spec
...
## Platform Scaling Applied to ALON Dome: ALON Dome Scale-Specific Fabrication Spec
...
## Fabrication Notes for ALON Dome Scale-Specific Fabrication Spec
...
### Material Requirements (Specific to ALON Dome Scale-Specific Fabrication Spec)
...
### Quality Check Points for ALON Dome Scale-Specific Fabrication Spec
...
*Document 67 of 52–135 for TOURMALINE.*
*Second-pass will add specific equations, drawings, and fabrication diagrams.*


---
*End F2-067 | TOURMALINE | CSMVessel-Charlemagne-FleetV2 | June 2026*
