# F2-114 — TOURMALINE: Accessibility and Ingress-Egress Design
...
**Section:** Interior
**Document:** Accessibility and Ingress-Egress Design
...
## Platform Scaling Applied to Interior: Accessibility and Ingress-Egress Design
...
## Fabrication Notes for Accessibility and Ingress-Egress Design
...
### Material Requirements (Specific to Accessibility and Ingress-Egress Design)
...
### Quality Check Points for Accessibility and Ingress-Egress Design
...
*Document 114 of 52–135 for TOURMALINE.*
*Second-pass will add specific equations, drawings, and fabrication diagrams.*


---
*End F2-114 | TOURMALINE | CSMVessel-Charlemagne-FleetV2 | June 2026*
