# F2-087 — TOURMALINE: Torque Vectoring Logic and Operating Modes
...
**Section:** Drivetrain
**Document:** Torque Vectoring Logic and Operating Modes
...
## Platform Scaling Applied to Drivetrain: Torque Vectoring Logic and Operating Modes
...
## Fabrication Notes for Torque Vectoring Logic and Operating Modes
...
### Material Requirements (Specific to Torque Vectoring Logic and Operating Modes)
...
### Quality Check Points for Torque Vectoring Logic and Operating Modes
...
*Document 87 of 52–135 for TOURMALINE.*
*Second-pass will add specific equations, drawings, and fabrication diagrams.*


---
*End F2-087 | TOURMALINE | CSMVessel-Charlemagne-FleetV2 | June 2026*
