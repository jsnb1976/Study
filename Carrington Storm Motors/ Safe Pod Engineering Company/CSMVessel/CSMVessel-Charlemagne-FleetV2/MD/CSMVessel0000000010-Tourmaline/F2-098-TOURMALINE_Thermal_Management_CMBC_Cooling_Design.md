# F2-098 — TOURMALINE: Thermal Management: CMBC Cooling Design
...
**Section:** Battery
**Document:** Thermal Management: CMBC Cooling Design
...
## Platform Scaling Applied to Battery: Thermal Management: CMBC Cooling Design
...
## Fabrication Notes for Thermal Management: CMBC Cooling Design
...
### Material Requirements (Specific to Thermal Management: CMBC Cooling Design)
...
### Quality Check Points for Thermal Management: CMBC Cooling Design
...
*Document 98 of 52–135 for TOURMALINE.*
*Second-pass will add specific equations, drawings, and fabrication diagrams.*


---
*End F2-098 | TOURMALINE | CSMVessel-Charlemagne-FleetV2 | June 2026*
