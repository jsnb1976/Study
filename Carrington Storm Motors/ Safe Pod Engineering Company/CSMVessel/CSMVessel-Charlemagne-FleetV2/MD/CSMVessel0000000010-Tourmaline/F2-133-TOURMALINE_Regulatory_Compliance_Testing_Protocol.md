# F2-133 — TOURMALINE: Regulatory Compliance Testing Protocol
...
**Section:** Testing
**Document:** Regulatory Compliance Testing Protocol
...
## Platform Scaling Applied to Testing: Regulatory Compliance Testing Protocol
...
## Fabrication Notes for Regulatory Compliance Testing Protocol
...
### Material Requirements (Specific to Regulatory Compliance Testing Protocol)
...
### Quality Check Points for Regulatory Compliance Testing Protocol
...
*Document 133 of 52–135 for TOURMALINE.*
*Second-pass will add specific equations, drawings, and fabrication diagrams.*


---
*End F2-133 | TOURMALINE | CSMVessel-Charlemagne-FleetV2 | June 2026*
