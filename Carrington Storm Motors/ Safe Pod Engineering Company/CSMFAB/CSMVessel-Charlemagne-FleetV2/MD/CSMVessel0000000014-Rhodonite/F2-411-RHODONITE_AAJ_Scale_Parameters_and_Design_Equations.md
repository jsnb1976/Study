# F2-411 — RHODONITE: AAJ Scale Parameters and Design Equations
...
**Scale Factor:** sf = 3.2
**Section:** AAJ System
**Document:** AAJ Scale Parameters and Design Equations
...
## Platform Scaling Applied to AAJ System: AAJ Scale Parameters and Design Equations
...
## Fabrication Notes for AAJ Scale Parameters and Design Equations
...
### Material Requirements (Specific to AAJ Scale Parameters and Design Equations)
...
### Quality Check Points for AAJ Scale Parameters and Design Equations
...
*Document 411 of 388–471 for RHODONITE.*
*Second-pass will add specific equations, drawings, and fabrication diagrams.*


---
*End F2-411 | RHODONITE | CSMVessel-Charlemagne-FleetV2 | June 2026*
