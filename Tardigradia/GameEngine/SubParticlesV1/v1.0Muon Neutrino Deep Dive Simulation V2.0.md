# The One-Muon-Neutrino Universe: Simulating Benevolent Non-Interference
...
**Particle Class:** Muon Neutrino ν_µ | Spin: 1/2 | Charge: 0 | Mass: < 0.19 MeV | Flavor oscillation | 2nd generation
**Source:** Extends `v1.0Muon Neutrino Deep Dive Simulation.pdf` (V1.0)
...
|---|---|---|---|
| **T2K/NOvA CP violation** | General NOvA/T2K mention | V2.0: T2K 2023 + NOvA 2023 combined: delta_CP = -90° to -60° preferred (NOvA weakly), T2K favors maximal CP violation at -90°. Best-fit: delta_CP = -135°. In simulation: CP phase in PMNS matrix set to -135° — creates 8% asymmetry in ν_µ vs anti-ν_µ appearance | T2K 2023; NOvA 2023 combined |
| **Atmospheric neutrino mass ordering** | Mass hierarchy unknown | V2.0: IceCube DeepCore 2023: first evidence for Normal Hierarchy from atmospheric neutrinos: p(NH)=83%. Combined with reactor/accelerator data: NH preferred at 3.5σ. V2.0 implements Normal Hierarchy by default: m₁ < m₂ < m₃ | IceCube DeepCore 2023; NuFIT 5.3 |
| **HyperK prediction for ν_µ range** | Not covered | V2.0: Hyper-Kamiokande (started 2023): expected 50× more events than Super-K. Will measure 8σ CP violation if delta_CP = -90° with 10 years data. V2.0: adds HyperK_DETECTION_EVENT when ν_µ → ν_e appearance occurs | HyperK TDR 2023 |
| **ν_µ NC cross-section precision** | General weak interaction | V2.0: MINERvA 2022-2024: ν_µ neutral current cross-section on carbon 0.2-10 GeV measured 3-5% precision. V2.0: cross-section table interpolated from MINERvA data, replaces V1.0 formulas with empirical lookup | MINERvA NC 2023 |
...
*End of v1.0Muon Neutrino Deep Dive Simulation V2.0 | Tardigradia Game Engine SubParticles Series*
