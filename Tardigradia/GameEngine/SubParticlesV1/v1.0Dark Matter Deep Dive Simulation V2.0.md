# Dark Matter: The Benevolence Thereof — Computational Framework for the Universal Substrate
...
**Particle Class:** Dark Matter (BSM) | Types: WIMP, FDM/Axion, Neutralino | Interacts: gravitationally only (SM) | ~27% universe
**Source:** Extends `v1.0Dark Matter Deep Dive Simulation.pdf` (V1.0)
...
|---|---|---|---|
| **LZ 2024 WIMP results** | XENON1T 2018 as reference | LZ (LUX-ZEPLIN) 2024: Most sensitive WIMP search ever. Spin-independent WIMP-nucleon cross-section limit: σ_SI < 9.2×10⁻⁴⁸ cm² at m_χ=36 GeV. WIMPs at 100 GeV mass essentially ruled out for weak-scale cross-sections | LZ Collaboration PRL 2024 |
| **JWST Fuzzy Dark Matter constraints** | No direct observational data | V2.0: JWST galaxy morphology (2023) provides strongest constraints on FDM: m_a > 10⁻²¹ eV from suppression of small-scale structure. Pushes FDM mass window to 10⁻²¹ to 10⁻¹⁸ eV range only | Schive et al. 2023 JWST; Nadler et al. 2024 |
| **Warm Dark Matter limits from Lyman-alpha** | CDM vs WDM overview | V2.0: Lyman-alpha forest (2022-2024) constrains thermal WDM: m_WDM > 5.3 keV at 95% CL. Only 'cold' dark matter variants survive current constraints | Rogers & Peiris 2022 |
| **Soliton core formation** | General FDM description | V2.0: FDM soliton core radius r_c = 1.9/(m_a * v_rms * r_vir^0.5) kpc. In simulation: central bright sphere of axion particles with r_c — surrounded by granular halo. 'Soliton breathing mode' oscillation at f = 1/(4*r_c) implemented | Schive et al. 2014; V2.0 engine |
...
*End of v1.0Dark Matter Deep Dive Simulation V2.0 | Tardigradia Game Engine SubParticles Series*
