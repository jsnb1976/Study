# The One-Photon Universe: Simulating Gauge Boson Identity and Massless Light
...
**Particle Class:** Photon γ | Spin: 1 | Mass: < 1×10⁻¹⁸ eV | Charge: 0 | Speed: c | Force: electromagnetic
**Source:** Extends `v1.0Gauge Boson Deep Dive Request.pdf` (V1.0)
...
|---|---|---|---|
| **Photon mass constraint** | Mass < 10⁻¹⁸ eV (V1.0 era) | V2.0: Fast Radio Burst (FRB 20190520B) dispersion measurement (2024): m_γ < 7.1×10⁻²³ eV — strongest astrophysical photon mass bound. In simulation: photon propagation includes tiny mass term only at cosmological scales | Wu et al. Nature Astron 2024 |
| **Photon entanglement distance record** | Quantum teleportation brief mention | V2.0: Chinese satellite Micius 2021-2024: photon entanglement maintained over 1200 km. V2.0 simulation: entanglement graph node connectivity limited only by simulation box size (not distance). Matches bosonic entanglement physics | Pan et al. Micius 2023 update |
| **Photon orbital angular momentum** | Helicity ±1 discussed | V2.0: OAM photon modes (Laguerre-Gaussian, l = 0,±1,±2...) included. OAM creates 'twisted light'. In simulation: photon instances with l≠0 follow helical worldline rather than straight. Visual: spiral trails for high-OAM photons | Allen et al. 1992; OAM applications 2024 |
| **Photon BEC in cavity** | Massless bosons cannot form BEC normally | V2.0: Photon BEC at room temperature (Klaers, Bonn 2023 update) — confined photons acquire effective mass m_eff = hbar*omega_0/c². Critical temperature: T_c proportional to n^(2/3)/m_eff. New PHOTON_MASSIVE mode added for cavity-confined photons | Klaers et al. 2023 |
...
*End of v1.0Gauge Boson Deep Dive Request V2.0 | Tardigradia Game Engine SubParticles Series*
