# The Hadronic Topological Architecture: Simulating Composite Quantum Identity
...
**Particle Class:** Hadrons (composite) | Baryons: qqq | Mesons: qq̄ | Exotica: qqq̄q̄, qqqq̄q | Strong-force bound
**Source:** Extends `v1.0Hadrons Deep Dive Request.pdf` (V1.0)
...
|---|---|---|---|
| **LHCb exotic hadrons** | No exotica in V1.0 | V2.0: LHCb 2022-2024: Tcc+ (doubly-charmed tetraquark), 3 pentaquarks, χc1(3872) exotic confirmed. V2.0 adds EXOTIC_HADRON category with quark content array up to 5 quarks. Charm quark content tracked separately for tetraquark formation | LHCb exotic hadrons 2022-2024 |
| **QCD lattice masses** | Experimental masses only | V2.0: BMW Lattice QCD (2021-2024): proton 938.3 MeV (matches exp. 0.5%), neutron 939.6 MeV, Omega baryon 1672.5 MeV. All masses now derived from first-principles alpha_s and quark masses. In simulation: mass lookup from lattice table rather than experimental PDG | BMW Lattice QCD 2024 |
| **Nucleon sigma term update** | Not covered | V2.0: sigma_piN (pion-nucleon sigma term) = 38±4 MeV (FLAG 2024 lattice average). Critical for dark matter nuclear scattering cross-section. In simulation: sigma_piN determines DARK_MATTER_INTERACTION rate with nucleons | FLAG 2024; LQCD review |
| **Hadron string breaking simulation** | String tension noted | V2.0: Lattice QCD string breaking: V(r) = sigma*r until r = r_break ~ 1.2 fm, then quark-antiquark pair creation. In simulation: LUND string fragmentation model — string breaks with probability P = exp(-pi m_q^2/sigma) per unit length per unit time | Lund string model; Altarelli review |
...
*End of v1.0Hadrons Deep Dive Request V2.0 | Tardigradia Game Engine SubParticles Series*
