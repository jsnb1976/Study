# The One-Muon Universe: Simulating Transient Heavy Lepton Identity
...
**Particle Class:** Muon µ⁻ | Mass: 105.66 MeV | Lifetime: 2.197 µs | Spin: 1/2 | Unstable — decays to eνν̄
**Source:** Extends `v1.0Muon Deep Dive_ One-Particle Universe.pdf` (V1.0)
...
|---|---|---|---|
| **Muon g-2 final FNAL result** | Preliminary FNAL result in V1.0 | V2.0: FNAL Muon g-2 final (2023): a_µ = (116 592 059 ± 22) × 10⁻¹¹, 5.1σ from SM (KNT18). BMW lattice: 1.5σ tension. V2.0 stores both SM values. Game mechanic: muon precession rate varies ±5σ depending on 'simulation mode' | FNAL 2023 final; BMW 2021 |
| **Muon to electron conversion** | Nuclear muon capture noted | V2.0: Mu2e@Fermilab (2023-2027) searching for µ→e conversion in aluminum: sensitivity to R(µe) < 10⁻¹⁷. If signal: new lepton flavor violation added to simulation. V2.0 tracks LFNV_AMPLITUDE per particle trajectory | Mu2e TDR 2023 |
| **Muon lifetime precision** | τ = 2.197 µs | V2.0: MuLan 2014 (used in V2.0): τ_µ = 2196980.3 ± 2.2 ps — sub-ppm precision. Determines G_F = 1.1663788×10⁻⁵ GeV⁻². V2.0: G_F updated in weak decay matrix elements | MuLan 2014 updated PDG 2024 |
| **Muon catalyzed fusion (µCF)** | Not covered | V2.0: Muon catalyzed fusion: µ replaces electron in H₂ molecule (Bohr radius × m_e/m_µ = 0.0053 Å). 100× smaller molecule. Fusion rate enhanced. V2.0 MUON_CATALYSIS mode: when muon enters nucleus separation < 10 fm, fusion event triggered | Petrov 1980; Breunlich 1989; update 2024 |
...
*End of v1.0Muon Deep Dive_ One-Particle Universe V2.0 | Tardigradia Game Engine SubParticles Series*
