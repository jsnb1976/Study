...
**Particle Class:** Neutron n | Mass: 939.565 MeV | Lifetime: 878.4 s | Spin: 1/2 | Charge: 0 | Quark content: udd
**Source:** Extends `v1.0Neutron Deep Dive_ One-Nucleon Universe.pdf` (V1.0)
...
|---|---|---|---|
| **Neutron lifetime puzzle** | τ_n ~ 880 s noted | V2.0: Beam vs. bottle tension persists at 3.4σ. Bottle: τ_n = 877.75±0.34 s. Beam: 888.0±2.0 s. Dark decay hypothesis: n→χ+γ with BR~1% could explain gap. V2.0: adds DARK_NEUTRON_DECAY branching ratio as configurable parameter | UCNτ 2023; Beam lifetime 2022 |
| **Neutron EDM search** | nEDM limit noted | V2.0: nEDM Collaboration (2020, confirmed 2023): |d_n| < 1.8×10⁻²⁶ e·cm. PSI/SNS nEDM aiming for 10⁻²⁸ by 2028. Strong CP problem: theta_QCD < 10⁻¹⁰ from this. V2.0: neutron EDM implements axion solution — adds axion coupling to neutron worldline CP phase | nEDM 2020; SNS nEDM TDR |
| **Neutron star merger GW constraints** | Not covered | V2.0: GW170817 + GW230529 (LIGO O4): neutron star radius R = 11.7±1.0 km. Tidal deformability Lambda=190±120. Constrains nuclear matter equation of state. V2.0: adds NEUTRON_STAR_MATTER mode where density > 2×nuclear saturation density | LIGO GW170817 2017; GW230529 2024 |
| **Free neutron quantum reflection** | Not covered | V2.0: GRANIT (ILL) 2023: neutrons in gravitational quantum states E_n = (m_n^2 g^2 hbar^2/2)^(1/3) × z_n. First 3 quantum states measured. V2.0: implements quantum gravitational orbital states for ultra-cold neutrons in 'cosmic level' simulation | GRANIT ILL 2023 |
...
*End of v1.0Neutron Deep Dive_ One-Nucleon Universe V2.0 | Tardigradia Game Engine SubParticles Series*
